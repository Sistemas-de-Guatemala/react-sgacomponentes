...
var AEtiqueta = React.forwardRef(function (props, ref) {
    props.visible || true;
    return (React.createElement("label", __assign({}, props, { style: props.estilos, className: "aetiqueta ".concat(props.className || ""), htmlFor: props.para }), props.children));
});
...
var ACajaTexto = React.forwardRef(function (props, ref) {
    var _a = useState(""), lbdError = _a[0], fijarLbdError = _a[1];
    var txtRef = useRef(null);
    var uuid = useMemo(function () { return aControl.GenerarUuidControl(); }, []);
    ...
    var TituloCajaTexto = function () {
        if (props.titulo) {
            return (React.createElement(AEtiqueta, { para: uuid, estilos: props.estilosTitulo, className: props.classNameTitulo }, props.titulo));
        }
        else {
            return null;
        }
    ...
    var TextoError = function () {
        if (lbdError === "") {
            ...
            return (React.createElement(AEtiqueta, { className: "acajatexto-error ".concat(props.classNameError || ""), estilos: props.estilosError }, lbdError));
        }
    };
    ...
    var Icono = function () {
        if (props.icono) {
            return (React.createElement("div", { className: "acajatexto-contenedor-icono ".concat(props.classNameIcono || ""), style: props.estilosIcono }, props.icono));
        }
        else {
            return null;
        }
    ...
    if (!visible) {
        ...
        return (React.createElement("div", { className: "acajatexto ".concat(props.className || ""), style: props.estilos },
            React.createElement(TituloCajaTexto, null),
            React.createElement("div", { className: "acajatexto-contenedor", style: { width: "100%" } },
                ...
                React.createElement(Icono, null)),
            React.createElement(TextoError, null)));
    }
});

export { ABoton, ABotonOpciones, ACajaTexto, AEtiqueta };
